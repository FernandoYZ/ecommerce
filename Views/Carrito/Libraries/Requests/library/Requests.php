 ...
 * by defining a `REQUESTS_SILENCE_PSR4_DEPRECATIONS` constant and setting it to `true`.
 * The constant needs to be defined before this class is required.
 */
define('REQUESTS_SILENCE_PSR4_DEPRECATIONS',true);
if (!defined('REQUESTS_SILENCE_PSR4_DEPRECATIONS') || REQUESTS_SILENCE_PSR4_DEPRECATIONS !== true) {
	...
	if (!defined('REQUESTS_SILENCE_PSR4_DEPRECATIONS')) {
